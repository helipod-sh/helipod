...
None of this requires a license key today, and none of it is expected to require one later. See [What is stackbase?](/docs/get-started/what-is-stackbase) for what the full engine actually includes, and [Self-hosting](/docs/deploy/self-hosting) for how deploy-anywhere works in practice.
