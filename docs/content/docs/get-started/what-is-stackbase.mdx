...
run stackbase yourself, on your own infrastructure, with no managed cloud in the middle.

## You write your backend as functions

Your functions live in a `stackbase/` folder:

<Files>

<Folder name="stackbase" defaultOpen>
