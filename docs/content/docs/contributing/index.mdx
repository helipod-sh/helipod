...
It aims for Convex-grade developer experience with no vendor lock-in. Run it on your own laptop, your own server, or your own cloud account.
...
- The built-in components: auth, scheduler, workflow, triggers, notifications.
