...
// `@helipod/triggers` reference pattern (see `../helipod.config.ts`): a durable audit log of
...
// is INTERNAL by Helipod's `_`-prefix convention (see `docs/enduser/triggers.md`'s "Handlers"
